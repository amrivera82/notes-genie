...
import { uploadAttachment } from "./NoteCaptureAPI";
...
export const VoiceNotesCaptureSlice = createSlice({
  name: "voiceNotesCapture",
  initialState,
...
export const { increment, decrement, incrementByAmount } = VoiceNotesCaptureSlice.actions;

// Export the slice reducer for use in the store configuration
export const voiceNotesCaptureReducer = VoiceNotesCaptureSlice.reducer;

// Selector functions allows us to select a value from the Redux root state.
// Selectors can also be defined inline in the `useSelector` call
// in a component, or inside the `createSlice.selectors` field.
export const selectCount = VoiceNotesCaptureSlice.selectors.selectCount;
export const selectStatus = VoiceNotesCaptureSlice.selectors.selectStatus;
