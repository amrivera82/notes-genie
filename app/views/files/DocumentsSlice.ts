...
import { uploadAttachment } from "./DocumentsAPI";
...
export const filesReducer = DocumentsSlice.reducer;

export const selectCount = DocumentsSlice.selectors.selectCount;
export const selectStatus = DocumentsSlice.selectors.selectStatus;
