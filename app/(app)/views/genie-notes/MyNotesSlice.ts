...
export interface MyNotesState {
  value: number,
  status: "idle" | "loading" | "failed"
}

// Define the initial value for the slice state
const initialState: MyNotesState = {
  value: 0,
  status: "idle"
};
...
export const { increment, decrement, incrementByAmount } = MyNotesSlice.actions;

// Export the slice reducer for use in the store configuration
export const myNotesReducer = MyNotesSlice.reducer;

export const selectCount = MyNotesSlice.selectors.selectCount;
export const selectStatus = MyNotesSlice.selectors.selectStatus;
