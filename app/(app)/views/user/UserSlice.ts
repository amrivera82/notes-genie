...
import { uploadAttachment } from "./UserAPI";
...
export const selectCount = UserSlice.selectors.selectCount;
export const selectStatus = UserSlice.selectors.selectStatus;
