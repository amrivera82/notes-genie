...
import { uploadAttachment } from "./MessengerAPI";
...
export const { increment, decrement, incrementByAmount } = MessengerSlice.actions;
...
export const selectCount = MessengerSlice.selectors.selectCount;
export const selectStatus = MessengerSlice.selectors.selectStatus;
